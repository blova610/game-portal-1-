...
interface AddNavigationItemDialogProps {
  open: boolean;
...
export function AddNavigationItemDialog({
  ...
  return (
    <BaseDialog
      ...
      description="Add a new item to your navigation menu"
      footer={
